...
import { B as __spreadArray, I as __extends, R as __read, c as Trie, d as invariant, v as maybe } from "./getOperationDefinition-BeZt9PRG.js";
import { B as equal, G as filter, H as mergeOptions, J as AsyncAction, K as observeOn, S as NetworkStatus, U as maybeDeepFreeze, V as preventUnhandledRejection, W as canUseDOM, q as AsyncScheduler, z as variablesUnknownSymbol } from "./core-BeTfRQFh.js";
import { b as canonicalStringify } from "./utilities-ZJ2tVyyQ.js";
...
var useLazyQuery = function useLazyQuery(query, options) {
...
* 
*/
var useMutation = function useMutation(mutation, options) {
	const client = useApolloClient(options?.client);
...
var useQuery = function useQuery(query, ...[options]) {
	"use no memo";
...
var useSuspenseQuery = function useSuspenseQuery(query, options) {
	"use no memo";
...
var useBackgroundQuery = function useBackgroundQuery(query, options) {
	"use no memo";
...
var useLoadableQuery = function useLoadableQuery(query, options = {}) {
	const client = useApolloClient(options.client);
	const suspenseCache = getSuspenseCache(client);
