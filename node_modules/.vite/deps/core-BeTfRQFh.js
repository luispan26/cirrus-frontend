import { c as OperationTypeNode, o as Kind, r as visit, t as BREAK } from "./visitor-BiWD8g6D.js";
import { t as parse } from "./parser-CSnJj4X7.js";
import { A as isFunction, B as __spreadArray, C as Subscriber, D as Subscription, E as EMPTY_SUBSCRIPTION, F as __awaiter, I as __extends, L as __generator, M as __asyncGenerator, N as __asyncValues, O as arrRemove, P as __await, R as __read, S as SafeSubscriber, T as reportUnhandledError, V as __values, _ as version, a as AutoCleanedWeakCache, b as identity, c as Trie, d as invariant, f as newInvariantError, h as makeUniqueId, j as __assign, k as createErrorClass, l as getOperationName, m as stringifyForDisplay, n as checkDocument, o as WeakCache, r as memoize, t as getOperationDefinition, u as cacheSizes, v as maybe, w as errorContext, x as observable, y as Observable } from "./getOperationDefinition-BeZt9PRG.js";
import { n as EMPTY, t as ApolloLink } from "./ApolloLink-BANrDpEN.js";
import { C as getInMemoryCacheMemoryInternals, E as isNonNullObject, S as getApolloClientMemoryInternals, T as DeepMerger, _ as dep, b as canonicalStringify, d as isReference, g as wrap, h as defaultMakeCacheKey, l as isSubscriptionOperation, m as DocumentTransform, n as isNetworkRequestSettled, p as print, s as isMutationOperation, t as isNetworkRequestInFlight, u as addTypenameToDocument, v as Slot, w as getMainDefinition, x as getApolloCacheMemoryInternals, y as mergeDeepArray } from "./utilities-ZJ2tVyyQ.js";
import { n as brand, r as isBranded, t as CombinedGraphQLErrors } from "./CombinedGraphQLErrors-Cr6fML0r.js";
	...
	execSelectionSetImpl({ selectionSet, objectOrReference, enclosingRef, context }) {
		...
		workSet.forEach((selection) => {
			...
			if (isField(selection)) {
				...
				if (!fragment && selection.kind === Kind.FRAGMENT_SPREAD) throw newInvariantError(112, selection.name.value);
		...
		(function flatten(selectionSet, inheritedContext) {
			...
			selectionSet.selections.forEach((selection) => {
				...
				if (isField(selection)) {
					...
					const fragment = getFragmentFromSelection(selection, context.lookupFragment);
					if (!fragment && selection.kind === Kind.FRAGMENT_SPREAD) throw newInvariantError(116, selection.name.value);
...
var CombinedProtocolErrors = class CombinedProtocolErrors extends Error {
	...
	*/
	...
	constructor(protocolErrors) {
		super(CombinedProtocolErrors.formatMessage(protocolErrors, { defaultFormatMessage }));
...
//#endregion
//#region node_modules/@apollo/client/core/RefetchEventManager.js
var defaultHandler = ({ client, matchesRefetchOn }) => {
	return client.refetchQueries({
		include: "active",
		onQueryUpdated: matchesRefetchOn
	});
};
var RefetchEventManager = class {
	sources;
	handlers;
	...
	*/
	connect(client) {
		...
		Object.entries(this.sources).forEach(([event, source]) => {
			if (typeof source === "function") this.subscribeToSource(event, source);
		});
	}
	/**
	...
	*/
	emit(source, ...args) {
		const [payload] = args;
		if (!this.client) {
			invariant.warn(102, source);
			return;
		}
		if (!this.hasSource(source)) {
			invariant.warn(103, source);
			return;
		}
		...
		function matchesRefetchOn(oq) {
			...
			if (typeof refetchOn === "boolean") return refetchOn;
			if (typeof refetchOn === "function") return refetchOn(ctx);
			if (typeof refetchOn?.[source] === "function") return refetchOn[source](ctx);
	...
	subscribeToSource(name, source) {
		...
		if (this.client) this.subscriptions.set(name, source().subscribe((value) => this.emit(name, value)));
	}
};
//#endregion
//#region node_modules/@apollo/client/core/refetchSources/onlineSource.js
var onlineSource = () => {
	return canUseDOM ? fromEvent(window, "online") : EMPTY;
};
//#endregion
//#region node_modules/@apollo/client/core/refetchSources/windowFocusSource.js
var windowFocusSource = () => {
...
gql["default"] = gql;
//#endregion
export { makeVar as A, equal as B, ServerParseError as C, UnconventionalError as D, LinkError as E, concat as F, filter as G, mergeOptions as H, split as I, AsyncAction as J, observeOn as K, from as L, MissingFieldError as M, ApolloCache as N, CombinedProtocolErrors as O, execute as P, empty$1 as R, NetworkStatus as S, LocalStateError as T, maybeDeepFreeze as U, preventUnhandledRejection as V, canUseDOM as W, windowFocusSource as _, resetCaches as a, ApolloClient as b, rewriteURIForGET as c, checkFetcher as d, defaultPrinter as f, parseAndCheckHttpResponse as g, selectHttpOptionsAndBodyInternal as h, gql as i, defaultDataIdFromObject as j, InMemoryCache as k, selectURI as l, selectHttpOptionsAndBody as m, disableFragmentWarnings as n, HttpLink as o, fallbackHttpConfig as p, AsyncScheduler as q, enableExperimentalFragmentVariables as r, createHttpLink as s, disableExperimentalFragmentVariables as t, createSignalIfSupported as u, onlineSource as v, ServerError as w, ObservableQuery as x, RefetchEventManager as y, variablesUnknownSymbol as z };
