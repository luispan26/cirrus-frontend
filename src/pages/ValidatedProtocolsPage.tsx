...
import { VALIDATED_PROTOCOLS_QUERY, REMOVE_VALIDATED_PROTOCOL_MUTATION } from '../graphql/operations';

interface ValidatedProtocolRow { id: string; protocolId: string; title: string; sourceUrl: string; createdAt?: string; }
